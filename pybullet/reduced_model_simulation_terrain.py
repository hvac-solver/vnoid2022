...
simulator = ReducedModelSimulator(urdf_path=model_info.urdf_path, time_step=time_step)
...
from robotoc_sim import TerrainSettings
terrain_settings = TerrainSettings(height_range=0.8, from_urdf=False)
simulator.set_terrain_settings(terrain_settings)
simulator.set_camera_settings(camera_settings=camera_settings)
q0[2] += 0.1 # avoid penetration 
...
simulation.run(mpc=mpc, t0=t0, q0=q0, simulation_time=simulation_time, 
               ...
               record=record, log=log, name='reduced_model')
